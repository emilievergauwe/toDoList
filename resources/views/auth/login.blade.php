            ...
            <div class="rounded-lg">
                <div class="bg-white shadow-lg py-4 px-5" style="border-radius : 18px; margin-right: 15%; margin-left: 15%">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        @csrf
                        <div>
                            <label class="font-weight-bold" style="font-size: 10px;" for="email">Your e-mail</label>
                            <div>
                        ...
                        <div>
                            <label class="font-weight-bold mt-3" style="font-size: 10px;" for="password">{{ __('Password') }}</label>
                            <div>
