            ...
            <div class="rounded-lg">
                <div class="bg-white shadow-lg py-4 px-5" style="border-radius : 18px; margin-right: 15%; margin-left: 15%">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        @csrf
                        <div>
                            <label class="loginLabels" for="email">Your e-mail</label>
                            <div>
                        ...
                        <div>
                            <label class="loginLabels mt-3" for="password">{{ __('Password') }}</label>
                            <div>
                        ...
                        <div class="d-flex justify-content-between mb-4 mt-4">
                            <a href="{{ route('password.request') }}" class="loginLabels darkBlue">Forgot password</a>
